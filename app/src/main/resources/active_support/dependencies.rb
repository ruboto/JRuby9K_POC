...
module ActiveSupport #:nodoc:
  module Dependencies #:nodoc:
    ...
    def load_missing_constant(from_mod, const_name)
      puts "load_missing_constant: from_mod: #{from_mod.inspect}, const_name: #{const_name.inspect}"
      puts "from_mod.parent: #{from_mod.parent.inspect}"
      unless qualified_const_defined?(from_mod.name) && Inflector.constantize(from_mod.name).equal?(from_mod)
        raise ArgumentError, "A copy of #{from_mod} has been removed from the module tree but is still active!"
      end

      qualified_name = qualified_name_for from_mod, const_name
      puts "qualified_name: #{qualified_name.inspect}"
      path_suffix = qualified_name.underscore
      puts "path_suffix: #{path_suffix.inspect}"
